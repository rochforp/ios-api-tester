...
/**
 * The PHYLocationManager class is used to discover iBeacons and query their
 * approximate distance to the device. You define regions that look for specific
...
/**
 * Initializes the PHYLocationManager with an App ID. You can obtain an
 * App ID from https://my.phy.net/apps
 *
 ...
 * PHYLocationManager will start returning any beacon if found for the region
...
/**
 * Invoked when the device enters the proximity of an ibeacon.
 *
 * @param manager the PHYLocationmanager object
 * @param region a PHY region
 */
